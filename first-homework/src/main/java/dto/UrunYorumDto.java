...
public class UrunYorumDto {
    ...
    public UrunYorumDto(String urunAdi, String kategoriAdi, BigDecimal urunFiyati, String kullaniciAdi, String kullaniciSoyadi, String kullaniciEmail, String kullaniciTelefon, String yorum, Date yorumTarihi) {
